...
namespace onlinebusinessApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                m.SwaggerDoc("v1",new Microsoft.OpenApi.Models.OpenApiInfo { Title="businnessTest",Version="v1"});
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseSwaggerUI(
                m =>
                {
                    m.SwaggerEndpoint("/swagger/v1/swagger.json", "businnessTest");
                });
        }
    }
}
